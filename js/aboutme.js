    ...
    document.querySelector("#content").innerHTML = `
        <div class="text-center">
            ...
            <div class="flex flex-col md:flex-row justify-center items-start text-left mt-4 gap-6">
                ...
                <p class="max-w-prose"> 
                    I'm Lucas, a Software Engineering student currently on my 3rd year of University.
                    I like to build anything that I randomly think of. Ranging from simple tools to use, small games or frontend themes.
                    ...
                    I decided to go for a software engineering as a degree, which I am really enjoying so far and I am excited to see where it takes me.
                </p>
            </div>
